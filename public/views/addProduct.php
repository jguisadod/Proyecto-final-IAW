...
-->
   <div class="container"> 
   <h2 style="text-align: center;">Añadir un nuevo producto</h2>
    ...
    <form class="form" action="index.php?controller=ProductController&action=aniadirProduct" method="post">
        ...
        <?php
            ...
            ?>
        <div class="form-group">
            <input class="form-control" type="submit" name="insertar" value="Añadir" style="background-color: blue; width:20%; margin-left:40%; margin-right:40%">
        </div>
